...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      <h1>图书馆</h1>
      <p class="lead text-muted">下面都是很好的书，主要和编程、算法、大数据相关，我知道看书肯定枯燥，但是锤炼人的思维。</p>
      <p>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
      ...
      <div class="row">
	  <c:forEach var="book" items="${wyw1813004316books }">
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <img class="bd-placeholder-img card-img-top" width="100%" height="500" role="img" aria-label="Placeholder: Thumbnail" src="./showImg/${book.getImg() }"/>
            <div class="card-body">
              <p class="card-text">
				  <strong>${book.getName()}</strong>
				  <div>图书ID是：${book.getId() }</div>
              </p>
              <div class="d-flex justify-content-between align-items-center">
                  <a type="button" href="./detail?wyw1813004316id=${book.getId() }" class="btn btn-sm btn-outline-secondary">查看详情</a>
				  <big class="text-primary" color="red">${book.getPrice() }¥</big>
              </div>
            </div>
          </div>
        </div>
...
<script src="/js/jquery.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
      <script>window.jQuery || document.write('<script src="/js/jquery.slim.min.js"><\/script>')</script><script src="/js/bootstrap.bundle.min.js" integrity="sha384-1CmrxMRARb6aLqgBO7yyAxTOQE2AKb9GfXnEo760AUcUmFx3ibVJJAzGytlQcNXd" crossorigin="anonymous"></script></body>
</html>
